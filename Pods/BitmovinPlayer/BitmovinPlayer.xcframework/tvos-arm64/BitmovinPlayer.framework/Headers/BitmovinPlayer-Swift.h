...
@protocol _BMPPlayerUIController;
...
SWIFT_CLASS_NAMED("_TVOSPictureInPictureSupportHelper")
@interface _BMPTVOSPictureInPictureSupportHelper : NSObject
- (nonnull instancetype)init;
@end


@interface _BMPTVOSPictureInPictureSupportHelper (SWIFT_EXTENSION(BitmovinPlayer)) <_BMPPictureInPictureSupportHelper>
@property (nonatomic, readonly) BOOL isPictureInPictureSupported;
@end
