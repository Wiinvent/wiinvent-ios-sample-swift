...
typedef SWIFT_ENUM(NSInteger, WIContentType, open) {
  WIContentTypeFILM = 0,
...
typedef SWIFT_ENUM(NSInteger, WIGender, open) {
  WIGenderMALE = 0,
  WIGenderFEMALE = 1,
  WIGenderOTHER = 2,
  WIGenderNONE = 3,
